...
const GALLERY_ITEMS: GalleryItem[] = [
  ...
  {
    id: "g2",
    caption: "Vocational Tailoring & Stitching Workshop",
  ...
  {
    id: "g5",
    caption: "Beautician & Self-Reliance Certification",
    category: "Women Empowerment",
    src: "/images/gallery-women.png",
    batchDate: "BATCH 2026 // SKILL 01",
    location: "Skill Center Annex, Lucknow",
  },
  {
    id: "g6",
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3 mb-10 border-b border-[#BDC1B3] pb-4">
          {CATEGORIES.map((cat) => (
            <button
              ...
              className={`px-4 py-2 text-xs font-mono font-bold tracking-wider uppercase transition-all tactical-cut-br ${
                activeCategory === cat
